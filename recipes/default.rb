...
execute "initialize #{node['mysql_demo']['database']['dbname']} database" do
  ...
  not_if  "mysql -h #{node['mysql_demo']['database']['host']} -u #{node['mysql_demo']['database']['admin_username']} -p#{node['mysql_demo']['database']['admin_password']} -D #{node['mysql_demo']['database']['dbname']} -e 'describe user;'"
end

# # Seed the database with a table and grant data.
# execute "initialize #{node['mysql_demo']['database']['dbname']} database" do
